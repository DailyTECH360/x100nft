...
import '../profit_staking/profitstak_page.dart';

class MyStakingIteam extends StatelessWidget {
  final StakingModel data;
  const MyStakingIteam({Key? key, required this.data}) : super(key: key);
      ...
      children: [
        Row(
          ...
          children: [
            Row(
              ...
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text('${staking.tr} ${data.symbol!} ${data.rateD}%/$day', style: const TextStyle(color: Colors.black, fontSize: 12)),
        ...
        Row(
          ...
          children: [
            ...
            const SizedBox(width: 5),
            InkWell(child: const Icon(Icons.list, color: Colors.black), onTap: () => Get.to(ProfitStakPage(uData: UserCtr.to.userDB!, id: data.id!)))
          ],
        ),
      ],
    );
