...
class DocPage extends GetView<UserCtr> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('$brandName Documents')),
      body: SafeArea(
        child: Center(
          child: Padding(
            ...
            child: Column(
              children: [
                const Icon(Icons.folder_shared, size: 100, color: Colors.white24),
                Text('Documents of $brandName', style: TextStyle(color: AppColors.primarySwatch)),
