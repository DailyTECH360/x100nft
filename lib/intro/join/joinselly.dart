...
class JoinSellPage extends GetWidget<JoinCtr> {
  JoinSellPage({Key? key}) : super(key: key);
    ...
    return GetX<JoinCtr>(
        ...
        builder: (_) {
          if (JoinCtr.toUCtr.userAuth != null) {
            ...
            return Container(
              decoration: const BoxDecoration(image: AppColors.bgImage0),
              child: Scaffold(
                    ...
                    child: SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Wg.logoBoxCircle(maxH: 120, padding: 10, color: Colors.black54, func: () => refreshApp()),
            ...
            child: Column(
              ...
              children: <Widget>[
                InternationalPhoneNumberInput(
                  initialValue: PhoneNumber(isoCode: GetStorage().read('language') ?? 'VN'),
  ...
  Widget waitOpenLinkInEmail() {
    return Padding(
      ...
      child: Column(
        children: [
          Image.asset("assets/kyc/check-your-email.png"),
          const SizedBox(height: 16),
